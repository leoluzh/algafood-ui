			...
			<div class="card">
				...
				<Toolbar class="p-mb-4">
					<template slot="left">
						...
						<Button label="Delete" icon="pi pi-trash" class="p-button-danger" @click="confirmDeleteSelected" :disabled="!selectedResturantes || !selectedResturantes.length" />
					</template>

				</Toolbar>

				<DataTable ref="dt" :value="restaurantes" :selection.sync="selectedResturantes" dataKey="id" :paginator="true" :rows="10" :filters="filters"
                            paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown" :rowsPerPageOptions="[5,10,25]"
                            currentPageReportTemplate="Showing {first} to {last} of {totalRecords} products">
					<template #header>
						<div class="table-header">
							<h5 class="p-m-0">Administrar Resturantes</h5>
